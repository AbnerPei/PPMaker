...
@interface NSURLSessionTask (XMRequest)

@property (nonatomic, strong) XMRequest *bindedRequest;

@end

@implementation NSURLSessionTask (XMRequest)

- (XMRequest *)bindedRequest {
    return objc_getAssociatedObject(self, _cmd);
}

- (void)setBindedRequest:(XMRequest *)bindedRequest {
