...
//横线
NSDateFormatterStyleKey const NSDateFormatterStyleKeyLine_yyyyMMdd_HHmmss     = @"yyyy-MM-dd HH:mm:ss";
NSDateFormatterStyleKey const NSDateFormatterStyleKeyLine_yyyyMMdd_HHmm       = @"yyyy-MM-dd HH:mm";
NSDateFormatterStyleKey const NSDateFormatterStyleKeyLine_yyyyMMdd            = @"yyyy-MM-dd";
NSDateFormatterStyleKey const NSDateFormatterStyleKeyLine_yyMMdd_HHmmss       = @"yy-MM-dd HH:mm:ss";
NSDateFormatterStyleKey const NSDateFormatterStyleKeyLine_yyMMdd_HHmm         = @"yy-MM-dd HH:mm";
...
//斜杠
NSDateFormatterStyleKey const NSDateFormatterStyleKeySlash_yyyyMMdd_HHmmss    = @"yyyy/MM/dd HH:mm:ss";
NSDateFormatterStyleKey const NSDateFormatterStyleKeySlash_yyyyMMdd_HHmm      = @"yyyy/MM/dd HH:mm";
NSDateFormatterStyleKey const NSDateFormatterStyleKeySlash_yyyyMMdd           = @"yyyy/MM/dd";
NSDateFormatterStyleKey const NSDateFormatterStyleKeySlash_yyMMdd_HHmmss      = @"yy/MM/dd HH:mm:ss";
NSDateFormatterStyleKey const NSDateFormatterStyleKeySlash_yyMMdd_HHmm        = @"yy/MM/dd HH:mm";
NSDateFormatterStyleKey const NSDateFormatterStyleKeySlash_yyMMdd             = @"yy/MM/dd";
NSDateFormatterStyleKey const NSDateFormatterStyleKeySlash_MMdd_HHmmss        = @"MM/dd HH:mm:ss";
NSDateFormatterStyleKey const NSDateFormatterStyleKeySlash_MMdd_HHmm          = @"MM/dd HH:mm";
