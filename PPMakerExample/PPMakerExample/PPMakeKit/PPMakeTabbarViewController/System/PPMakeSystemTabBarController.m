...
-(UIViewController *)creatTabbarItemWithIndex:(NSInteger)index
{
    ...
    [vc.tabBarItem setTitleTextAttributes:@{NSForegroundColorAttributeName:kColorBlack,NSFontAttributeName:kFontMedium(10)} forState:UIControlStateNormal];
    [vc.tabBarItem setTitleTextAttributes:@{NSForegroundColorAttributeName:kColorBlack,NSFontAttributeName:kFontSemibold(10)} forState:UIControlStateSelected];
